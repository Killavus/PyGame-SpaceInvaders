...
class EnemyInsect(Enemy):
  def __init__(self, x, y, bulletsGroup):
    ...
    insectConst = constants["spritemaps"]["insect1"]
  ...
  def spawnBullet(self):
    return InsectBullet( self.rect.centerx, self.rect.topleft[1] + 20 )
