...
class EnemySpeedInsect(Enemy):
  def __init__(self, x, y, bulletsGroup):
    ...
    insectConst = constants["spritemaps"]["insect3"]
  ...
  def spawnBullet(self):
    return SpeedBullet( self.rect.centerx, self.rect.topleft[1] + 20 )
